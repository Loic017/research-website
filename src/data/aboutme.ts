...
export const aboutMe: AboutMe = {
  ...
  <br></br>
  I earned my BSc in Computer Science from Cardiff University in 2024, graduating with First Class Honours. My dissertation on EEG seizure detection with TinyML was presented with the best undergraduate dissertation award. 
  <br></br>
  Currently, I am undergoing an MPhil under the supervision of Dr Amir Javed, investigating machine learning intrusion detection for vehicular 🚙 systems.
  <br></br>
