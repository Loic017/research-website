...
export const publicationData: Publication[] = [
  // If you don't want to show publications, just make the array empty.
  {
    ...
    tldr: "We fine-tune the model for stress detection and evaluate it on a 40-subject open stress dataset. We also conducted experiments to compare the foundation model approach with traditional machine learning methods and highlight several observations for future research in this direction.",
    // imageUrl:
